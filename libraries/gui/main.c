...
#ifndef PLATFORM_LINUX
  printf("[DEBUG] Ready to boot LVGL via native L2 Allocator...\n");
...
#ifdef DEBUG_BUILD
  printf("[MAIN] LVGL initialised successfully!\n");
#endif
 ...
 * ========================================================================= */
void pe_start(void) { /* Reserved for future multi-core use on NusaCore */ }
